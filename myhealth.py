...
# -------------------------------
default_tasks = {
    "아침루틴": ["소금물1컵 마시기", "아침 햇빛 쬐기 + 가벼운 산책 + 스트레칭", "찬물샤워 + 아침 거르기"],
    "점심루틴": ["과식하지 않기", "천천히 식사하기", "식후 가벼운 산책"],
    "저녁루틴": ["저녁 7시 이전 식사", "식후 20분 산책", "전자기기 줄이고 독서"],
    "공부집중": ["동기부여", "모다피닐, 녹차, 은행잎 추출물", "포모도로 25분 + 10분 휴식"],
    "체력": ["푸시업 15 x 3", "스쿼트 15 x 3", "조깅 + 달리기 30~40분"],
    "식단": ["단백질 보충", "야채 섭취", "가공식품 먹지 않기"],
}
